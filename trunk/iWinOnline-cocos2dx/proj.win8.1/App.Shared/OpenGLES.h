...
public:
	...
	//EGLSurface CreateSurfaceBackground(Windows::UI::Xaml::Controls::SwapChainBackgroundPanel^ panel, const Windows::Foundation::Size* renderSurfaceSize, const float* renderResolutionScale);
