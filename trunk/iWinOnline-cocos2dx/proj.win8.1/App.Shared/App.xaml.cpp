...
void CocosAppWinRT::App::OnActivated(Windows::ApplicationModel::Activation::IActivatedEventArgs^ args)
{

	if (args->Kind == ActivationKind::WebAuthenticationBrokerContinuation)
	{
		WebAuthenticationBrokerContinuationEventArgs^ s =(WebAuthenticationBrokerContinuationEventArgs^)args;
		WPPlatform::WPHelper::Finalize(s);
		//WPPlatform::WPHelper::
		//SessionService.Instance.Finalize(s->WebAuthenticationResult);
	}
}
