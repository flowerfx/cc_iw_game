...
public:
    Cocos2dRenderer(int width, int height, float dpi, 
        ...
        Windows::UI::Core::CoreDispatcher^ dispatcher, Windows::UI::Xaml::Controls::Panel^ panel ,Windows::Foundation::Point scale_factor);
    ~Cocos2dRenderer();
	...
	void SetScaleFactor(Windows::Foundation::Point scale_factor);
	Windows::Foundation::Size GetCurrentViewSize();
private:

    int m_width;
    int m_height;
    float m_dpi;
	Windows::Foundation::Point m_scalefactor;
