...
#include "Cocos2dEngine/OpenGLES.h"
#include "Cocos2dEngine/OpenGLESPage.g.h"
#include <memory>
#include <condition_variable>
#include <mutex>

#include "Cocos2dEngine/Cocos2dRenderer.h"
...
namespace CocosAppWinRT
{
    ...
    private:
		Windows::UI::Xaml::Controls::Primitives::Popup^ popup_webview;
		...
		void  getAcessToken(Platform::String^ code, std::function<void(void*, std::string)> callBack);
        float mDpi;
        bool mDeviceLost;
        bool mVisible;
        bool mCursorVisible;
