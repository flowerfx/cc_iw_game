...
#include "GameScreens/Xam/XamScreen.h"
...
void GamePlayMgr::RegisterGameScreen()
{
	...
	p_factory_game_screen_entity.RegisterProduct<CoTuongScreen>(GameType::GAMEID_CO_UP);
	p_factory_game_screen_entity.RegisterProduct<XamScreen>(GameType::GAMEID_XAM);
}
