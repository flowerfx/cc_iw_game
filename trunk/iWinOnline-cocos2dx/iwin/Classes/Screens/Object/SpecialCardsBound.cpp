...
void SpecialCardsBound::setSpecialType(SpecialType type)
{
    _spr_glow_top->stopAllActions();
    _spr_glow_bot->stopAllActions();
    switch(type)
    {
        case SpecialType::TYPE_2:
        {
            cocos2d::SpriteFrameCache* spriteFrameCached = 	cocos2d::SpriteFrameCache::getInstance();
            cocos2d::SpriteFrame* spriteFrame = spriteFrameCached->getSpriteFrameByName("gamescreen-tienlen-screen/vachxanhduong.png");
            _spr_glow_top->setSpriteFrame(spriteFrame);
            _spr_glow_bot->setSpriteFrame(spriteFrame);
        }
            break;
        case SpecialType::TYPE_3:
        {
            cocos2d::SpriteFrameCache* spriteFrameCached = 	cocos2d::SpriteFrameCache::getInstance();
            cocos2d::SpriteFrame* spriteFrame = spriteFrameCached->getSpriteFrameByName("gamescreen-tienlen-screen/vachxanhla.png");
            _spr_glow_top->setSpriteFrame(spriteFrame);
            _spr_glow_bot->setSpriteFrame(spriteFrame);
            _spr_glow_bot->setTexture(spriteFrame->getTexture());
        }
            break;
        case SpecialType::TYPE_1:
        default:
        {
            cocos2d::SpriteFrameCache* spriteFrameCached = 	cocos2d::SpriteFrameCache::getInstance();
            cocos2d::SpriteFrame* spriteFrame = spriteFrameCached->getSpriteFrameByName("gamescreen-tienlen-screen/vachsang.png");
            _spr_glow_top->setSpriteFrame(spriteFrame);
            _spr_glow_bot->setSpriteFrame(spriteFrame);
        }
            break;
