...
public:
	...
	*/
	...
	static std::vector<unsigned char> autoWhenMultiSelectTLMN(TienLenPlayer* player, std::vector<unsigned char> cardSelect, std::vector<unsigned char> curentCards);
	static bool checkArrayItemContain(std::vector<unsigned char> arr1, std::vector<unsigned char> arr2);
	static std::vector<unsigned char> getListIdToListIndex(std::vector<Card*> list_cards,std::vector<unsigned char> index);
