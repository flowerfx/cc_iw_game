...
public:
    ...
    static std::vector<Phom> findPhomWithOneCard(ubyte cardID, VecByte freeCard);
    static VecByte canCanMakePhomOneCard(ubyte cardID);
    static std::vector<Phom> checkPhom(VecByte eatCards, VecByte dealCards);
    static std::vector<Phom> findPhomFromListCard(VecByte cards, VecByte newFree);
};
