...
CC_SYNTHESIZE(std::string, taixiuHelp, TaiXiuHelp);
CC_SYNTHESIZE(std::string, cashoutHelp, CashoutHelp);
CC_SYNTHESIZE(std::string, shopWinHelp, ShopWinHelp);
CC_SYNTHESIZE(std::string, shopRubyHelp, ShopRubyHelp);
