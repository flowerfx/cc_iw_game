...
namespace iwinmesage
{
	...
	rapidjson::Document Guides::toJson()
	{
		...
		rapidjson::Value vtaixiuHelp(taixiuHelp.c_str(), taixiuHelp.size());
		document.AddMember("taixiuHelp", vtaixiuHelp, locator);
		rapidjson::Value vcashoutHelp(cashoutHelp.c_str(), cashoutHelp.size());
		document.AddMember("cashoutHelp", vcashoutHelp, locator);
		rapidjson::Value vshopWinHelp(shopWinHelp.c_str(), shopWinHelp.size());
		document.AddMember("shopWinHelp", vshopWinHelp, locator);
		rapidjson::Value vshopRubyHelp(shopRubyHelp.c_str(), shopRubyHelp.size());
		document.AddMember("shopRubyHelp", vshopRubyHelp, locator);
	...
	void Guides::toData(rapidjson::Document & document)
	{
		...
		if (document.HasMember("taixiuHelp"))
		{
			setTaiXiuHelp(document["taixiuHelp"].GetString());
		}
		if (document.HasMember("cashoutHelp"))
		{
			setCashoutHelp(document["cashoutHelp"].GetString());
		}
		if (document.HasMember("shopWinHelp"))
		{
			setShopWinHelp(document["shopWinHelp"].GetString());
		}
		if (document.HasMember("shopRubyHelp"))
		{
			setShopRubyHelp(document["shopRubyHelp"].GetString());
		}
	}
}
