...
namespace iwinmesage
{
	...
	rapidjson::Document GetMinMaxBoard::toJson()
	{
		...
		document.AddMember("maxMoneyRoom", maxMoneyRoom, locator);
	...
	void GetMinMaxBoard::toData(rapidjson::Document & document)
	{
		...
		{
			setMaxMoney(document["maxMoney"].GetInt64());
		}
		if (document.HasMember("maxMoneyRoom"))
		{
			setMaxMoneyRoom(document["maxMoneyRoom"].GetInt64());
		}
