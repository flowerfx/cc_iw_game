...
void ServerMgr::addServerTests()
{
	...
	_servers.push_back(Server("Tuan test", "10.8.14.149", "11068"));
	_servers.push_back(Server("Hoang Test", "10.8.14.92", "19124"));
...
void ServerMgr::UpdateServerListFromString(std::string serverListStr)
{
	_servers.clear();
	initFromString(serverListStr);
}