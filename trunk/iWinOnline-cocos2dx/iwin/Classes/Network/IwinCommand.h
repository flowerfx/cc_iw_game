...
namespace IwinCommand
{
	...
	*/
	...
	static std::string CLIENT_DIALOG_SUBMIT = "CLIENT_DIALOG_SUBMIT";
	/**
	...
	*/
	static std::string INVITE_FACEBOOK = "INVITE_FACEBOOK";
	/**
	...
	*/
	...
	static std::string TAIXIU_GET_HISTORY = "TAIXIU_GET_HISTORY";
	static std::string TAIXIU_GET_HISTORY_RUBY = "TAIXIU_GET_HISTORY_RUBY";

	static std::string TAIXIU_GET_MATCH_HISTORY = "TAIXIU_GET_MATCH_HISTORY";
	static std::string TAIXIU_GET_MATCH_HISTORY_RUBY = "TAIXIU_GET_MATCH_HISTORY_RUBY";

	/**
	* lay lich su choi game , lich su nap tien
	*/
	static std::string GET_TRANSACTION_HISTORY = "GET_TRANSACTION_HISTORY";

	/*
	* yêu cầu clien phải điền code xác thực OTP
	*/

	static std::string REQUIRE_AUTHEN_OTP = "REQUIRE_AUTHEN_OTP";

	/*
	* client gưởi code xác thực lên cho server
	*/
	static std::string AUTHORIZE_OTP = "AUTHORIZE_OTP";
    
    /**
     * client gui client info moi
     * */
    static std::string SET_CLIENT_DEVICE_INFO = "SET_CLIENT_DEVICE_INFO";

	/*
	* Lay thong tin game no hu
	*/
	static std::string NOHU_GET_INFO = "NOHU_GET_INFO";
	/*
	* Lay thong tin no hu ruby
	*/
	static std::string NOHU_GET_INFO_RUBY = "NOHU_GET_INFO_RUBY";
	/*
	* nohu dat cuoc
	*/
	static std::string NOHU_BET = "NOHU_BET";
	/*
	* lich su no hu cua minh
	*/
	static std::string NOHU_GET_USER_HISTORY = "NOHU_GET_USER_HISTORY";
	/*
	* lay lich su nhung nguoi choi co no hu win
	*/
	static std::string NOHU_GET_LIST_NOHU = "NOHU_GET_LIST_NOHU";
	/*
	* close win
	*/
	static std::string NOHU_CLOSE = "NOHU_CLOSE";
	/*
	* lay danh sach game khong ho tro no hu
	*/
	static std::string NOHU_GET_UNSUPPORTED_LIST = "NOHU_GET_UNSUPPORTED_LIST";
