...
//{
	...
	// All Link Define Here.
	 ...
	 #define  LINK_TERM  "https://iwin.me/tin-tuc-mobile/2-dieu-khoan-su-dung"
	 #define  LINK_BACKGROUND_WINFREE  "http://av.iwin.me/wf/imgWinFreeBG.png"
	 #define  LINK_CUSTOMER_SERVICE  "http://hotro.iwin.vn/login?type=2"
	 #define  LINK_CUSTOMER_SERVICE_FULL  "http://hotro.iwin.vn/login?type=1"
	 #define  LINK_WEB  "http://iwin.me"
	...
	#define  BUNDLE_ID_ANDROID_M  "iwin.vn.m"

	#define TRACKING_PURCHASE_CANCEL "iwin.appevent.purchasecancel"
	#define TRACKING_PURCHASE_CANCEL1  "iwin.appevent.purchasecancel1"
	#define TRACKING_INITIATED_CHECKOUT  "iwin.inappevent.initiatedcheckout"
	#define TRACKING_CLICK_SIGNUP  "iwin.inappevent.signup"
	#define TRACKING_CLICK_EVENT  "iwin.inappevent.clickevent"
	#define TRACKING_LAST_LOCATION  "iwin.inappevent.lastlocation"
	#define TRACKING_OPEN_PUSHNOTIFICATION  "iwin.inappevent.openpushnotification"
	#define TRACKING_CLICK_SHARE_EVENT  "iwin.inappevent.share"
	#define TRACKING_CLICK_INVITE  "iwin.inappevent.invite"

	/**
	* Android list mail package
	*/
	#define LIST_APP_EMAIL_PACKAGE_ANDROID  "com.google.android.gm,com.yahoo.mobile.client.android.mail,com.microsoft.office.outlook,com.zoho.mail,ru.yandex.mail,de.gmx.mobile.android.mail"
	#define LIST_APP_EMAIL_NAMEAPP_ANDROID  "Gmail,Yahoo,OutLook,Zoho,Yandex,Gmx"
	#define SMS_DEFAULT_PACKAGE_ANDROID  "com.android.mms"
	#define SMS_DEFAULT_PACKAGE_IOS  "sms:"

	/**
	* Link App Google Authentication for IOS
	*/
	#define LINK_WP_APP_GOOGLE_AUTHENTICATION  "https://www.microsoft.com/en-us/store/p/authenticator/9wzdncrfj3rj"
	#define LINK_IOS_APP_GOOGLE_AUTHENTICATION  "itms://itunes.apple.com/us/app/google-authenticator/id388497605?mt=8"
	#define LINK_ANDROID_APP_GOOGLE_AUTHENTICATION  "https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en"

	#define URL_SCHEME_IOS_GOOGLE_AUTHENTICATION  "googleauthenticator://"
	...
	*/
	...
	#define GETOS_ANDROID  "android"
	#define FACEBOOK_LINK  "https://www.facebook.com/"
	#define GOOGLE_LINK  "https://www.google.com/"


   //char VERSION_ENCODE[] = { 0,0,0,5,-104,-78,-126,53,121,-125,-56,70 };
//}
#endif // 